    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="konten_artikel" id="konten_artikel" rows="9" required><?= $mapel["konten_artikel"]; ?></textarea>
            </div>
            <div class="mb-3">
                <label for="foto_artikel" class="form-label">Foto Artikel</label>
                <input class="form-control form-control-sm" name="foto_artikel" id="foto_artikel" type="file" value="<?= $mapel['foto_artikel'] ?>">
                <div class="mt-3">
            ...
            <button class="btn btn-success mb-5" type="sumbit" name="submit">Ubah Data</button>
