...
<body>
    ...
    <h1 class="text-center mt-5">Ubah Data Pelajaran</h1>
    <form action="" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_pelajaran" value="<?= $mapel["id_pelajaran"] ?>">
        <input type="hidden" name="gambarLama" value="<?= $mapel["foto_pelajaran"] ?>">

        <div class="container">
            <div class="mb-3">
                <label for="nama_pelajaran" class="form-label">Nama Pelajaran</label>
                <input type="text" class="form-control" name="nama_pelajaran" id="nama_pelajaran" required value="<?= $mapel["nama_pelajaran"]; ?>">
            </div>
            <div class="mb-3">
                <label for="penjelasan_pelajaran" class="form-label">Penjelasan Pelajaran</label>
                <input type="text" class="form-control" rows="3" name="penjelasan_pelajaran" id="penjelasan_pelajaran" required value="<?= $mapel["penjelasan_pelajaran"]; ?>"></input>
            </div>
            <div class="mb-3">
                ...
                <div class="mt-3">
                    ...
                    <img src="../../source/images/pelajaran/<?= $mapel['foto_pelajaran'] ?>" alt="<?= $mapel['nama_pelajaran'] ?>" width="150px">
                </div>
            </div>
