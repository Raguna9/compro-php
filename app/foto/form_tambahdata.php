...
<body>
    ...
    <h1 class="text-center mt-5">Tambah Data Foto</h1>
    <form action="" method="post" enctype="multipart/form-data">

        <div class="container">
            <div class="mb-3">
                <label for="ket_foto" class="form-label">Keterangan Foto</label>
                <input type="text" class="form-control" name="ket_foto" id="ket_foto" required>
            </div>
            <div class="form-group">
                <label for="kategori_foto">Kategori:</label>
                <select class="form-control" id="kategori_foto" name="kategori_foto">
