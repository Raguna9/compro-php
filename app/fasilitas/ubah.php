...
$fasilitas = query("SELECT * FROM fasilitas WHERE id_fasilitas =$id")[0];
...
if (isset($_POST["submit"])) {
    ...
    if (ubahFasilitas($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = '../../adm/adm_fasilitas.php'
        </script>
        ";
    } else {
        echo "
...
<body>
    ...
    <h1 class="text-center mt-5">Ubah Data Fasilitas</h1>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nama_fasilitas" id="nama_fasilitas" required value="<?= $fasilitas["nama_fasilitas"]; ?>">
            </div>
