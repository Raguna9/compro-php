        ...
        <div class="card border border-success" style="height: 450px">
          ...
          <div class="card-body">
            <blockquote class="blockquote">
              <p class="mb-0 text-start">"Terwujudnya Generasi Qur'ani yang Agamais (berpendidikan agama) Ala
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                a)&nbsp;&nbsp;Mencetak santri yang fasih dan tartil dalam membaca Al-Qur'an
              </li>
              <li class="list-group-item">
                b)&nbsp;&nbsp;Menumbuhkan kebiasaan yang agamais
              </li>
              <li class="list-group-item">
                c)&nbsp;&nbsp;Membentuk santri berakhlakul karimah sesuai tuntutan agama
              </li>
              <li class="list-group-item">
                d)&nbsp;&nbsp;Mewujudkan santri yang beriman dan bertaqwa
              </li>
              <li class="list-group-item">
                e)&nbsp;&nbsp;Mengembangkan kajian keilmuan ala ahlussunnah waljama'ah
              </li>
              <li class="list-group-item">
                f)&nbsp;&nbsp;Membentuk anak didik menuju apa yang disebut sebagain Insan Kamil
              </li>
              <li class="list-group-item">
                g)&nbsp;&nbsp;Membentuk karakter santri secara maksimal
              </li>
              <li class="list-group-item">
                h)&nbsp;&nbsp;Memanfaatkan segala potensi yang ada pada santri
              </li>
            </ul>
          </div>
        </div>
