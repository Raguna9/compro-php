        ...
        <footer class="py-1">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                <ul class="list-unstyled d-flex">
                    <li class="ms-3">
                        <a class="link-dark" href="https://www.youtube.com/channel/UCH0zbOzXx1x3d4oCvc-c0WA"
                    ...
                    <li class="ms-3">
                        <a class="link-dark" href="https://web.facebook.com/YPPDA" target="_blank"><svg class="bi"
                                width="24" height="24">
