...
<body>
    <div>
        <div class="sidebar p-4 bg-success" id="sidebar">
            ...
            <hr class="text-white" />
            <li>
                <a class="text-white nav-link active" href="adm_pelajaran.php">
                    <i class="bi bi-book"></i>
                    Pelajaran
                </a>
            </li>
            <li>
                <a class="text-white nav-link bg-warning" href="adm_fasilitas.php">
                    <i class="bi bi-building"></i>
                    Fasilitas
                </a>
            </li>
            <li>
                <a class="text-white nav-link" href="adm_foto.php">
    ...
    <?php include 'data_fasilitas.php' ?>
