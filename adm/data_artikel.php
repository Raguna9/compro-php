...
<center class="m-5">
    <h2>Artikel</h2>
    <!-- </center> -->
    <a href="../app/artikel/form_tambahdata.php" class="btn btn-sm btn-info text-light mb-1 " style="float: left;">Tambah
        data</a>
    <!-- <center> -->
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="../app/artikel/ubah.php?id=<?php echo $result['id_artikel']; ?>" class="btn btn-sm btn-warning">Edit</a>
                        <a href="../app/artikel/hapus.php?id=<?php echo $result['id_artikel']; ?>" class="btn btn-sm btn-danger mt-2">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
