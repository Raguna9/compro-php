        ...
        ?>
            <div class="col">
              <div class="card shadow-sm">
                ...
                <button type="button" class="btn btn-border-0" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $i ?>" style="height: 300px;">
                  <img src="source/images/foto/<?= $result['foto'] ?>" alt="<?php echo $result['ket_foto']; ?>" style="width: 100%; height: 100%; object-fit: cover;" />
                </button>
